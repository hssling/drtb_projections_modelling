...
We developed a deterministic sub-model to forecast the burden of drug resistance.
...
*   **Calculated Output:** $Burden_{DR} = (Notify_{New} \times Rate_{New}) + (Notify_{Ret} \times Rate_{Ret})$
...
*   **The "New Case Paradox":** The most critical finding of this study is the source attribution (Figure 1C). By 2030, **67% (approx. 106,000 cases)** of all DR-TB patients will be *new* cases. Only 33% will come from the retreatment pool.
...
India is not a single epidemiological zone; it is a continent of diverse sub-epidemics. Our state-level clustering and forecasting (Figure 2) reveal:
*   **The "Big 5" Hotspots:** **Uttar Pradesh, Bihar, Maharashtra, Madhya Pradesh, and Rajasthan** are projected to shoulder **>55%** of the national DR-TB burden.
    *   *Uttar Pradesh* alone faces a projected burden of **48,028** DR-TB cases in 2030, a caseload larger than the total national burden of many countries.
    *   *Bihar* and *Maharashtra* follow with ~15,000 and ~12,000 cases respectively.
*   **Demographic Impact:** Our age-wise heatmap analysis (Figure 3) of these high-burden states reveals that the disease is not affecting the elderly or infirm most; rather, the **15–30** and **31–45** age cohorts show the highest infection density.
