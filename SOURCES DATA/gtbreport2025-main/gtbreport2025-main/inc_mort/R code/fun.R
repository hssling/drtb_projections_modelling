#' ---
#' title: Functions
#' author: Philippe Glaziou, with adaptations by Mathieu Bastard
#' date: 04/07/2024
                     ...
                     noHIV = TRUE)
{
  ...
  CFR.ARTu <-
    c(mean(c(ART1.u.cfr, ART2.u.cfr)),
      mean(c(ART1.u.cfr.sd, ART2.u.cfr.sd)))
  CFR.ARTd <-
    c(mean(c(ART1.n.cfr, ART2.n.cfr)),
      mean(c(ART1.n.cfr.sd, ART2.n.cfr.sd)))
