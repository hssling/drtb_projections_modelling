...
#'
#'
#' Data received from UNAIDS on 28 July 2025
...
suppressWarnings(unaids <-
                   as.data.table(
                     read_excel(
                       'data/unaids/HIV2025Estimates_ForTBmodel_AllCountries_Embargoed10uly_9July2025.xlsx',
                       sheet = 1,
                       skip = 2,
                       col_types = typz
                     )
...
#' check aggregates
#'
(unaids[, sums(mort.hiv.num), by=year])
